...
function updateContato($conn, $id, $data)
{
    ...
    if ($stmt->errno) {
        ...
        header("Location: ../atividades/editar_atividade.php?atividade_id=" . $id . "&mensagem=Atividade atualizada com sucesso!");
...
<body onload="redirecionarParaLogin()">
    ...
    <div class="container">
        ...
        <div class="main tabela-projetos">
            ...
            <form action="../atividades/editar_atividade.php" method="POST">

...
// Função para buscar dados do banco de dados Contatos
...
{
    $query = "INSERT INTO contatos_tecnicos (Nome, Telefone, Email, Coordenadorias_ID, Tipos_Contatos_ID) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($query);

    // Bind parameters
    $stmt->bind_param("ssssi", $data['Nome'], $data['Telefone'], $data['Email'], $data['Coordenadoria'], $data['Contatos']);
    ...
    if ($stmt->errno) {
        ...
        header("Location: inserir_contato.php?mensagem=Contato inserido com sucesso!");
...
<body onload="redirecionarParaLogin()">
    ...
    <div class="container">
        ...
        <div class="main tabela-projetos">
            ...
            <form action="../contatos/inserir_contato.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="Contatos" name="Contatos" required>
                        ...
                        <?php
                        $conn = conectarBanco();
                        buscarDadosContatos($conn, "tipos_contatos", "Nome");
                        $conn->close();
                        ?>
                    </select>
                ...
                <button type="submit" name="submit_inserir" class="btn btn-primary">
                    <i class="fas fa-plus"></i> Inserir Contato
                </button>

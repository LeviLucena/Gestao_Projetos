...
function buscarDadosAtividades($conn)
{
        ...
        <div class="main mx-auto tabela-projetos">
            <table id="atividades-table" class="table table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    $dadosContatos = buscarDadosAtividades($conn);
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-visualizar').on('click', function () {
                ...
                window.location.href = '../atividades/editar_atividade.php?atividade_id=' + atividadeID;
            });
        });

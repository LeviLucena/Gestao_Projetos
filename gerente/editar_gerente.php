...
$result_usuario = "SELECT * FROM gerente_projeto WHERE ID = '$id'";
$resultado_usuario = mysqli_query($conn, $result_usuario);
$row_usuario = mysqli_fetch_assoc($resultado_usuario);

// Função para buscar dados do banco de dados dos gerentes
...
{
    $sql = "SELECT * FROM gerente_projeto WHERE ID = '$id'";
    $result = $conn->query($sql);
...
{
    $query = "UPDATE gerente_projeto SET Nome = ? WHERE ID = ?";
    ...
    // Check for errors
    if ($stmt->errno) {
        echo "Erro ao atualizar gerente: " . $stmt->error;
    } else {
        // Redireciona para a página de edição após a atualização
        header("Location: ../gerente/editar_gerente.php?id=" . $id . "&mensagem=Gerente atualizado com sucesso!");
...
<body onload="redirecionarParaLogin()">
    ...
    <div class="container">
        ...
        <div class="main tabela-projetos">
            ...
            <form action="../gerente/editar_gerente.php" method="POST">
                ...
                <p>
                    ...
                    <script>
                        ...
                        document.getElementById('btn-cancelar').addEventListener('click', function () {
                            ...
                            window.location.href = '../gerente/inserir_gerente.php';
                        });
                    </script>
